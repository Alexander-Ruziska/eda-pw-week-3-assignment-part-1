...
let favoriteFoods = ['pizza', 'tacos', 'lasagna', 'bacon' ];
...
let entree = 'smoked salmon';
favoriteFoods.unshift(entree);
console.log(`Added an entree to beginning of: ${favoriteFoods}`);
...
console.log('Removed the last color from', colors);
console.log('The color is now', lastColor);
